...
import parseTxAmmClawbackFlags from "../ledger/tx-amm-clawback-flags";

function parseAmmClawback(tx: AMMClawback, nativeCurrency?: string): FormattedAmmClawbackSpecification {
  ...
  return removeUndefined({
    ...
    flags: parseTxAmmClawbackFlags(tx.Flags as number, { nativeCurrency }),
    memos: parseMemos(tx),
  });
}
