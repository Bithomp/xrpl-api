...
describe("Models", () => {
  ...
  describe("getTxDetails", () => {
    ...
    it("EscrowCreate MPToken", function () {
      const tx = require("../examples/responses/EscrowCreateMPT.json");
      const result: any = Models.getTxDetails(tx, false, "XRP");
      expect(result).to.eql({
        type: "escrowCreation",
        address: "rh6iZBNDiDSDmekSJqTZTHRnT2hNQJk5fA",
        sequence: 54906,
        id: "45D255B56446F337295158E10CED9868A62C156D41BD14A0727A14E43726BDA2",
        ctid: "C000D67F00020002",
        specification: {
          source: { address: "rh6iZBNDiDSDmekSJqTZTHRnT2hNQJk5fA" },
          destination: { address: "r3etb2R2JDcQS2gXBJk4M4ShutXJe2zkhs" },
          amount: {
            mpt_issuance_id: "0000D678277F62543F873DD8018E1BC8740EB7040B6A636D",
            value: "10000",
        ...
        outcome: {
          result: "tesSUCCESS",
          timestamp: "2025-10-05T12:59:32.000Z",
          fee: "0.0001",
          balanceChanges: {
            rh6iZBNDiDSDmekSJqTZTHRnT2hNQJk5fA: [{ currency: "XRP", value: "-0.0001" }],
          },
          lockedBalanceChanges: {
            rh6iZBNDiDSDmekSJqTZTHRnT2hNQJk5fA: [
              { value: "10000", mpt_issuance_id: "0000D678277F62543F873DD8018E1BC8740EB7040B6A636D" },
            ],
          },
          escrowChanges: {
            status: "created",
            escrowIndex: "0C353F704FC83A79EC3EBC2C844C0B1A0397BE8E2F38228AD955B47AB63870FF",
            escrowSequence: 54906,
            amount: { mpt_issuance_id: "0000D678277F62543F873DD8018E1BC8740EB7040B6A636D", value: "10000" },
            source: { address: "rh6iZBNDiDSDmekSJqTZTHRnT2hNQJk5fA" },
            destination: { address: "r3etb2R2JDcQS2gXBJk4M4ShutXJe2zkhs" },
            allowExecuteAfter: "2025-10-05T12:59:45.000Z",
    ...
    it("EscrowFinish MPToken", function () {
      const tx = require("../examples/responses/EscrowFinishMPT.json");
      const result: any = Models.getTxDetails(tx, false, "XRP");
      expect(result).to.eql({
        type: "escrowExecution",
        address: "r3etb2R2JDcQS2gXBJk4M4ShutXJe2zkhs",
        sequence: 54907,
        id: "5065E2DB078E7D4A98180099F66A126545BC5A6323B67C00B5BAC32C69C1E62F",
        ctid: "C000D68600000002",
        specification: {
        ...
        outcome: {
          result: "tesSUCCESS",
          timestamp: "2025-10-05T12:59:52.000Z",
          fee: "0.0001",
          balanceChanges: {
    ...
    it("EscrowFinish MPToken 4", function () {
      const tx = require("../examples/responses/EscrowFinishMPT4.json");
      const result: any = Models.getTxDetails(tx, false, "XRP");
      expect(result).to.eql({
        type: "escrowExecution",
        address: "rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp",
        sequence: 304603,
        id: "CC0DBFC3ACBB2A6CC9D28657E8DAB695C77551692A56E87A20198CC1CAB34A65",
        ctid: "C004A5E200210002",
        specification: {
          source: { address: "rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp" },
          owner: "rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp",
          escrowSequence: 304602,
          flags: { innerBatchTxn: false },
        },
        outcome: {
          result: "tesSUCCESS",
          timestamp: "2025-10-14T11:12:12.000Z",
          fee: "0.0001",
          balanceChanges: {
            rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp: [{ currency: "XRP", value: "-0.0001" }],
          },
          lockedBalanceChanges: {
            rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp: [
              { value: "-10000", mpt_issuance_id: "0004A5D844183F0EE0624C81F411F0C77A2FC335F1E81B1E" },
            ],
          },
          escrowChanges: {
            status: "executed",
            escrowIndex: "32596A13B97BCF8B4711F809AE09633CD9D4BA44DCC27FAD78374922EB483822",
            escrowSequence: 304602,
            amount: { mpt_issuance_id: "0004A5D844183F0EE0624C81F411F0C77A2FC335F1E81B1E", value: "10000" },
            source: { address: "rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp" },
            destination: { address: "rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp" },
            allowExecuteAfter: "2025-10-14T11:12:06.000Z",
            previousTxnID: "6B40CDFB9315C0A93BECC6C960170913CED040FFEF33C57E33F464A3197092B3",
            previousTxnLgrSeq: 304607,
          },
          mptokenIssuanceChanges: {
            "0004A5D844183F0EE0624C81F411F0C77A2FC335F1E81B1E": {
              status: "modified",
              flags: {
                locked: false,
                canLock: false,
              ...
              mptIssuanceID: "0004A5D844183F0EE0624C81F411F0C77A2FC335F1E81B1E",
              issuer: "rfDsz5nx3xWS7j6H5pQFfrM2V4YGzfXdvC",
              sequence: 304600,
              maximumAmount: "10000",
              outstandingAmount: "10000",
              lockedAmount: "0",
          ...
          mptokenChanges: {
            "0004A5D844183F0EE0624C81F411F0C77A2FC335F1E81B1E": {
              rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp: {
                ...
                flags: { locked: false, authorized: false },
                mptIssuanceID: "0004A5D844183F0EE0624C81F411F0C77A2FC335F1E81B1E",
                account: "rEeii5Et4ysPswpvULUz1TPua4zGJgFcRp",
                amount: "10000",
                lockedAmount: "0",
                lockedAmountChange: "-10000",
              },
