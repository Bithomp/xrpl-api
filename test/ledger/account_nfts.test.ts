...
describe("Client", () => {
  describe("xls20", () => {
        ...
        expect(result.account_nfts).to.eql([
          {
            ...
            NFTokenID: "000B0000C124E14881533A9AFE4A5F481795C17003A9FACF0000099B00000000",
            NFTokenTaxon: 0,
          ...
          },
          {
            Flags: 11,
            Issuer: "rJcEbVWJ7xFjL8J9LsbxBMVSRY2C7DU7rz",
            NFTokenID: "000B0000C124E14881533A9AFE4A5F481795C17003A9FACF2DCBAB9D00000002",
            NFTokenTaxon: 0,
            URI: "697066733A2F2F516D516A447644686648634D7955674441784B696734416F4D547453354A72736670694545704661334639515274",
            nft_serial: 2,
          },
    ...
    describe("findAccountNfts", () => {
      it("works", async function () {
        const result: any = await Client.findAccountNfts("rJcEbVWJ7xFjL8J9LsbxBMVSRY2C7DU7rz", { limit: 200 });
        expect(result.account_nfts).to.eql([
          {
            Flags: 11,
            Issuer: "rJcEbVWJ7xFjL8J9LsbxBMVSRY2C7DU7rz",
    ...
    describe("getAccountNftSellOffers", () => {
      it("works", async function () {
        ...
        expect(result.offers[0]).to.eql({
          ...
          flags: 1,
          nft_offer_index: "0FEDCDB1A329C80B5BF75F3EC3D7634A03B9CCC41B34E67E36C951BA08065D31",
    ...
    describe("getAccountNftBuyOffers", () => {
      it("works", async function () {
        ...
        expect(result.offers[0]).to.eql({
          amount: "1",
          flags: 0,
          nft_offer_index: "F5BC0A6FD7DFA22A92CD44DE7F548760D855C35755857D1AAFD41CA3CA57CA3A",
