  ...
  describe("mainnet", () => {
    ...
    describe("findTransactions", () => {
      ...
      it("returns transaction with specification", async function () {
        ...
        expect(result[0].rawTransaction).to.eql(
